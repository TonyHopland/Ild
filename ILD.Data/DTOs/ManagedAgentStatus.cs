...
/// Drives the install/update button: it is shown enabled only when
/// <see cref="UpdateAvailable"/> is true. When <see cref="InstalledVersion"/> is
/// null the button installs the latest version (fresh deployment); otherwise it
/// updates the existing install.
/// </summary>
...
/// True when an install or update is actionable: the latest version is known and
/// either nothing is installed yet or the installed version is behind.
/// </param>
